...
| H3 ⏸ | A3 | `Managers/ShoutManager.cs:45,160,179` | Managers→Api/Auth/Core 역방향 다중 결합 | **스킵**: line 160(ShoutApi)·179(ServerTime)은 안정적 인프라로 위반 아님. line 45(AuthManager.PlayerId) 읽기 전용 단순 조회라 1인 개발 기준 EventManager 캐싱 비용 > 실익. CLAUDE.md 의존성 방향 규칙 1줄 추가로 대체 |
